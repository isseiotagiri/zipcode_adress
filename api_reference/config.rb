...
require './lib/nesting_unique_head_multibyte_character.rb'
...
set :markdown,
    ...
    renderer: NestingUniqueHeadCounterMultibyteCharacter
...
set :sass_assets_paths, [FontAwesome::Sass.stylesheets_path]
...
sprockets.append_path FontAwesome::Sass.stylesheets_path
